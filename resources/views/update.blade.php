...
<form action={{route('actualizarCon',$item->id)}} method="POST" class="w-full">
    @csrf
    @method('PUT')
    <div class="flex items-center border-b border-teal-500 py-2">
        <label  class="text-3xl" for="nombre">Nombre</label>
        <input value={{$item->nombre}} id="nombre" name="nombre" class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Jane Doe" aria-label="Full name">
    </div>
    <div class="flex items-center border-b border-teal-500 py-2">
        <label  class="text-3xl" for="apellido">Apellido</label>
        <input value={{$item->apellido}} id="apellido" name="apellido" class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Jane Doe" aria-label="Full name">
    </div>
    <div class="flex items-center border-b border-teal-500 py-2">
        <label  class="text-3xl" for="telefono">Telefono</label>
        <input value={{$item->telefono}} id="telefono" name="telefono" class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Jane Doe" aria-label="Full name">
    </div>
    <div class="flex items-center border-b border-teal-500 py-2">
        <label  class="text-3xl" for="email">Email</label>
        <input value={{$item->email}} id="email" name="email" class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Jane Doe" aria-label="Full name">
    </div>
